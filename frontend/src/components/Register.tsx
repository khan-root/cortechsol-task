        ...
        <div className="flex items-center justify-center">
          ...
          <form className="space-y-4 w-full px-10 md:p-10">
            ...
            <div className="flex justify-end">
              <span className="text-white text-sm cursor-pointer hover:text-white/80">Already have an account? Login</span>
            </div>
            <div className="flex justify-center">
              <Button className="bg-white text-black cursor-pointer hover:bg-white/80 hover:text-black">Register</Button>
            </div>
          </form>
      </div>
    </div>
